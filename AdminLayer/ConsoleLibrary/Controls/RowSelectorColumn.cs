...
namespace Mediachase.Web.Console.Controls {
	...
	public class RowSelectorColumn : DataGridColumn
	{
        ...
        /// </summary>
        /// <param name="radioSelector">The radio selector.</param>
        ...
        /// </summary>
        /// <value>The select all control.</value>
		...
		[
		DefaultValue("~/scripts/RowSelectorColumnScript.js"),
		Description("Gets/Sets path to script file.")
		]
		public virtual string ScriptPath
		{
			get
			{
				object savedState = this.ViewState["ScriptPath"];
				if (savedState != null)
				{
					return (string)savedState;
				}
				return "~/scripts/RowSelectorColumnScript.js";
			}
			set
			{
        ...
        /// <summary>
        /// Handles the ServerChange event of the selector control.
        /// </summary>
		...
		{
			if (this.Owner.Page != null && !String.IsNullOrEmpty(ScriptPath))
			{
				if (!this.Owner.Page.ClientScript.IsClientScriptBlockRegistered("Mediachase.CommerceManager.RowSelectorColumn Library"))
				{
					string path = HttpContext.Current.Server.MapPath(ScriptPath); //"~/scripts/RowSelectorColumnScript.js");
					try
					{
						if (File.Exists(path))
						{
							...
							{
								//String script = "<script language='javascript'>\r\n<!--\r\n" + HttpContext.GetGlobalResourceObject("ConsoleResources", "RowSelectorColumnScript") + "\r\n//-->\r\n</script>";
								String script = "<script language='javascript'>\r\n<!--\r\n" + reader.ReadToEnd() + "\r\n//-->\r\n</script>";
								this.Owner.Page.ClientScript.RegisterClientScriptBlock(typeof(RowSelectorColumn), "Mediachase.CommerceManager.RowSelectorColumn Library", script);
							}
						}
					}
					catch { }
		...
		public class ParticipantRadioButton : System.Web.UI.HtmlControls.HtmlInputRadioButton, IPostBackDataHandler
		{
            ...
            /// <returns>
            /// true if the <see cref="T:System.Web.UI.HtmlControls.HtmlInputRadioButton"/> control's state has changed as a result of the postback; otherwise, false.
            /// </returns>
            ...
            /// </summary>
            /// <value>The rendered name attribute.</value>
            /// <remarks>
