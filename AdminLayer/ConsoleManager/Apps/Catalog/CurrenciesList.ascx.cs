...
{
	public partial class CurrenciesList : CatalogBaseUserControl
	{
		/// <summary>
		...
		private void LoadDataAndDataBind(string sortExpression)
		{
			...
			{
				DataView view = dto.Currency.DefaultView;
				view.Sort = sortExpression;
				MyListView.DataSource = view;
			}

			MyListView.CurrentListView.PrimaryKeyId = EcfListView.MakePrimaryKeyIdString("CurrencyId");
			MyListView.DataBind();
		}
