...
<asp:Image ID="Image1" runat="server" 
    ImageUrl='<%# DataBinder.Eval(DataItem, "[Type]", "~/app_themes/Default/images/icons/{0}.gif")%>'
...
<asp:HyperLink ID="HyperLink1" runat="server" 
    ...
    Text='<%# EcfListView.GetDataCellValue(DataBinder.Eval(DataBinder.GetDataItem(Container),"[Name]")) %>' 
...
Text='<%# EcfListView.GetDataCellValue(DataBinder.Eval(DataItem, "[Name]")) %>' 
