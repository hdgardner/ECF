...
<div class="wh100" style="padding-left:10px; padding-right:5px; padding-top:10px; padding-bottom:5px;">
   ...
   <asp:Label runat="server" ID="lblImportDescription" Text="<%$ Resources:CatalogStrings, Catalog_Import_Instructions %>"></asp:Label><br /><br />
        ...
        <asp:TableRow>
            <asp:TableCell>
                <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpCtrl" 
                    ...
                    <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/document_add.png") %>' width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Add_New_File %>" /></div></ShowTextTemplate>
                    <HideTextTemplate><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/scrollup_hover.gif") %>' width="16" height="16" border="0" title="Hide" /><span class="FileUploadHideBlock">&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Hide_Panel %>" /></span></HideTextTemplate>
                    <UploadTextTemplate><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/publish.gif") %>' width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Upload_File %>" /></span></UploadTextTemplate>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%" >
                    <tr>
                        <td style="width: 311px">
                            <b><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Uploaded_File %>" />:</b>
                        </td>
                    </tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div align="left">
			                            ...
			                            <asp:LinkButton Font-Bold="true" ForeColor="Blue" runat="server" ID="lbSaveFiles" Text="<%$ Resources:SharedStrings, Save_The_File %>" CssClass="text"></asp:LinkButton>
		                            </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
        ...
        <asp:TableRow>
            <asp:TableCell Width="100%">
                ...
                <mc:FileUploadProgress ID="fuProgress" runat="server" FileUploadControlID="FileUpCtrl" 
                  ...
                  <WaitTemplate><i><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Upload_Wait %>" /></i></WaitTemplate>
                    <InfoTemplate>
                        <em><asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Upload_Info %>" /></em>
                    </InfoTemplate>
    ...
    <div style="padding-left:5px; padding-right:5px; padding-top:5px; padding-bottom:5px;">
        <b><asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:CatalogStrings, Catalog_Import_Files_Available %>" />:</b>
        <br />
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    <tr>
                        <td align="left">
                            <core:FileList ID="FilesControl" runat="server" Folder='<%# Mediachase.Web.Console.Common.ManagementHelper.GetImportExportFolderPath(_CatalogImportFolder) %>' GridAppId="Catalog" GridViewId="FilesList-Import" SelectedBtnId='<%# btnImport.ClientID %>' />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
