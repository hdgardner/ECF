...
<div id="DataForm">
 <table class="DataForm">
    <tr>
        <td>
            <input type="button" onclick="EntryAssociationItem_Edit(0);" id="showDlg" value="Add an association" />
        </td>
     </tr>
    <tr>
        <td>
            <table>
                <tr>
                    ...
                    <td>
                          <ComponentArt:ComboBox id="AssociationsFilter" runat="server" 
                            AutoHighlight="false"
                            AutoComplete="true"
                            AutoFilter="true"
                            CssClass="comboBox"
                            ...
                            DropHoverImageUrl="App_Themes/Main/images/combobox/drop_hover.gif"
                            DropImageUrl="App_Themes/Main/images/combobox/drop.gif"
                            DropDownPageSize="10"
                            Width="350"
                            Debug="False">
                            <%--
         ...
         <asp:Panel id="pnlSelectedAssociation" runat="server" Visible="false">
            ...
            <table class="DataForm"> 
                <tr>
                 ...
                 <tr>
                    <td>
                        <ComponentArt:Grid Debug="false" AllowEditing="true" EnableViewState="true" RunningMode="Client" 
                            AutoFocusSearchBox="false" ShowHeader="false" ShowFooter="false" 
                            ...
                            <ClientTemplates>
                                ...
                                <ComponentArt:ClientTemplate ID="HyperlinkTemplate">
                                    <a href="javascript:AssociationItemsGrid.edit(AssociationItemsGrid.getItemFromClientId('## DataItem.Arguments ##'));"><img alt="edit" src="../../../App_Themes/Default/Images/edit.gif" /></a> | <a href="javascript:AssociationItemsGrid.deleteItem(AssociationItemsGrid.getItemFromClientId('## DataItem.ClientId ##'))"><img alt="delete" src="../../../App_Themes/Main/Images/toolbar/delete.gif" /></a>
                                </ComponentArt:ClientTemplate>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td style="font-size: 10px;">
                                                Loading...&nbsp;</td>
                                            <td>
                                                <img src="App_Themes/Main/images/grid/spinner.gif" alt="Loading" width="16" height="16" border="0">
                                        </tr>
                                    </table>
                                </ComponentArt:ClientTemplate>
                                  <ComponentArt:ClientTemplate Id="EditTemplate">
                                    <a href="javascript:AssociationItemsGrid.edit(AssociationItemsGrid.getItemFromClientId('## DataItem.ClientId ##'));"><img alt="edit" src="../../../App_Themes/Default/Images/edit.gif" /></a> | <a href="javascript:AssociationItemsGrid.deleteItem(AssociationItemsGrid.getItemFromClientId('## DataItem.ClientId ##'))"><img alt="delete" src="../../../App_Themes/Main/Images/toolbar/delete.gif" /></a>
                                  </ComponentArt:ClientTemplate>
