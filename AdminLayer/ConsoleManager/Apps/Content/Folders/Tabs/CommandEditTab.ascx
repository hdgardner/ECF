...
<div id="DataForm">
    <table>
        <tr>
            <td class="FormLabelCell"><asp:Label ID="Literal5" runat="server" Text='<%$ Resources:Admin, QueryString %>'></asp:Label>:</td>
            <td class="FormFieldCell">
                <asp:TextBox runat="server" Width="250" ID="tbQueryString"></asp:TextBox>
            </td>
        </tr>
        <tr id="RolesRow" runat="server">
            <td class="FormLabelCell" nowrap><asp:Label ID="Literal1" runat="server" Text='<%$ Resources:Admin, Name %>'></asp:Label>:</td>
