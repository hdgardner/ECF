...
namespace Mediachase.Commerce.Manager.Content.Workflow
{
    public partial class StateList : BaseUserControl
    {
        /// <summary>
        ...
        public int WorkflowId
        {
            get
            {
                return ManagementHelper.GetIntFromQueryString("workflowid");
            }
        }
