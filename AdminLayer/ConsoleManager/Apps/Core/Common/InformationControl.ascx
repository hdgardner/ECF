...
<div style="width:100%; padding: 10px 10px 10px 10px;">
    ...
    <br />
    <br />
	<asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:SharedStrings, Content_System_Version %>"/>:&nbsp;<asp:Label runat="server" ID="ContentSystemVersionText"></asp:Label>
    <br />
    <br />
    ...
    <br />
    <br />
    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:SharedStrings, Profile_System_Version %>"/>:&nbsp;<asp:Label runat="server" ID="ProfileSystemVersionText"></asp:Label>
    <br />
    <br />
    <br />
    <br />
