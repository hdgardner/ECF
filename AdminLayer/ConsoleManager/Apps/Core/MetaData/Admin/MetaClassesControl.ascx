                        ...
                        <tr>
                            ...
                            <td class="FormFieldCell">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorFriendlyName" ControlToValidate="FriendlyName"
                                    Display="None" Font-Name="verdana" Font-Size="9pt" ErrorMessage="<%$ Resources:SharedStrings, Friendly_Name_Required %>"
                        ...
                        <tr>
                            <td colspan="2" class="FormFieldCell">
                                <asp:DataGrid ID="ItemsGrid" runat="server" CssClass="Grid" AllowPaging="False" Width="100%"
                                    ...
                                    <Columns>
                                        <console:RowSelectorColumn ItemStyle-Width="50" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center" allowselectall="false" SelectionMode="Multiple"
                                            HeaderText="Select" AutoPostBack="False" />
                                        <asp:TemplateColumn HeaderText="Sort" HeaderStyle-Width="50">
                                            <ItemTemplate>
