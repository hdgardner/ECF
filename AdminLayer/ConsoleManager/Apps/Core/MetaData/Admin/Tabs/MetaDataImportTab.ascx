        ...
        <asp:TableRow>
            <asp:TableCell>
                <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpCtrl" 
                    ...
                    <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/document_add.png") %>' width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:SharedStrings, Add_New_File %>"/></div></ShowTextTemplate>
                    <HideTextTemplate><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/scrollup_hover.gif") %>' width="16" height="16" border="0" title="Hide" /><span class="FileUploadHideBlock">&nbsp;<asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:SharedStrings, Hide_Panel %>"/></span></HideTextTemplate>
                    <UploadTextTemplate><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/publish.gif") %>' width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:SharedStrings, Upload_File %>"/></span></UploadTextTemplate>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div align="left">
			                            ...
			                            <asp:LinkButton Font-Bold="true" ForeColor="Blue" runat="server" ID="lbSaveFiles" Text="<%$ Resources:CoreStrings, MetaData_Save_The_File %>" CssClass="text"></asp:LinkButton>
		                            </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
        ...
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    <tr>
                        <td align="left">
                            <core:FileList ID="FilesControl" runat="server" Folder='<%# Mediachase.Web.Console.Common.ManagementHelper.GetImportExportFolderPath(_MetaDataImportFolder) %>' GridAppId='<%# AppId %>' GridViewId="FilesList-Import" SelectedBtnId='<%# btnImport.ClientID %>' />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
