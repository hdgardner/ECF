...
namespace Mediachase.Commerce.Manager.Core.MetaData.MetaControls
{
	...
	/// </summary>
    public partial class DecimalControl : CoreBaseUserControl, IMetaControl
	{
        ...
        public void Update()
        {
			if(String.IsNullOrEmpty(MetaValueCtrl.Text) && MetaField.AllowNulls)
                ...
                MetaHelper.SetMetaFieldValue(MetaField.Context, MetaObject, MetaField.Name, new object[] { Decimal.Parse(MetaValueCtrl.Text) });
        }
        #endregion
	}
}
