<%@ Control Language="c#" Inherits="Mediachase.Commerce.Manager.Core.MetaData.Controls.EmailControl" Codebehind="EmailControl.ascx.cs" %>
   ...
   <tr>  
     ...
     <td class="FormFieldCell">
		...
		<asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ErrorMessage="<%$ Resources:SharedStrings, Valid_Email_Required %>" Display="Dynamic" ControlToValidate="MetaValueCtrl" ValidationExpression="^([a-zA-Z0-9_\-\.']+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"></asp:RegularExpressionValidator>
