...
namespace Mediachase.Commerce.Manager.Core.MetaData.MetaControls
{
	...
	/// </summary>
    public partial class IntegerControl : CoreBaseUserControl, IMetaControl
	{
		...
		private void BindData()
		{
            ...
            MetaValueCtrl.Text = MetaObject == null ? "" : MetaObject.GetInt32(MetaField).ToString();
        ...
        public void Update()
        {
			if(String.IsNullOrEmpty(MetaValueCtrl.Text) && MetaField.AllowNulls)
				...
				MetaHelper.SetMetaFieldValue(MetaField.Context, MetaObject, MetaField.Name, new object[] { Int32.Parse(MetaValueCtrl.Text) });
        }
        #endregion
	}
}
