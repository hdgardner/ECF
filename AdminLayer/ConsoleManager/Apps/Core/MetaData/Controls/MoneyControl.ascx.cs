...
namespace Mediachase.Commerce.Manager.Core.MetaData.MetaControls
{
    ...
    /// </summary>
    public partial class MoneyControl : CoreBaseUserControl, IMetaControl
    {
        ...
        private void BindData()
        {
            ...
            MetaValueCtrl.Text = MetaObject == null ? "" : MetaObject.GetDecimal(MetaField).ToString();
        ...
        public void Update()
        {
            if (String.IsNullOrEmpty(MetaValueCtrl.Text) && MetaField.AllowNulls)
                MetaHelper.SetMetaFieldValue(MDContext, MetaObject, MetaField.Name, new object[] { null });
            else
                MetaHelper.SetMetaFieldValue(MDContext, MetaObject, MetaField.Name, new object[] { Decimal.Parse(MetaValueCtrl.Text) });
        }
        #endregion
    }
}
