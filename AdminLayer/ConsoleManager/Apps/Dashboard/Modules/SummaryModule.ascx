        ...
        <div class="summary-row">
            <div class="summary-item">
                <div class="body">
                    <div class="stat">
                        <div class="image">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/App_Themes/Default/Images/Icons/Bundle.gif" /></div>
                        <div class="name">
            ...
            <div class="summary-item">
                <div class="body">
                    <div class="stat">
                        <div class="image">
                            <asp:Image runat="server" ImageUrl="~/App_Themes/Default/Images/Icons/node.gif" /></div>
                        <div class="name">
