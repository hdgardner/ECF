...
public partial class Apps_Marketing_Promotions_BuyXGetNofYatReducedPrice : PromotionBaseUserControl
{
    ...
    {
        public string EntryXSkuSet = String.Empty;
        public string EntryYFilter = String.Empty;
        public char EntryXSkuDelimiter = SkuEntryHelper.SkuEntryDelim;
        public bool Exclude = false;
        public decimal MaxYQuantity = 1;
    ...
    protected void AddEntry_Click(object sender, EventArgs e)
    {
        ...
        skuEntrys.AddSkuEntry(EntryXFilterSet.SelectedEntryCode);
    ...
    public override void SaveChanges(IDictionary context)
    {
        ...
        settings.Exclude = this.ExcludeEntry.Checked;
        settings.EntryXSkuSet = this.PersistSkuEntrys;
        settings.EntryYFilter = EntryYFilter.SelectedEntryCode;
        settings.MaxYQuantity = Decimal.Parse(MaxQuantity.Text);
