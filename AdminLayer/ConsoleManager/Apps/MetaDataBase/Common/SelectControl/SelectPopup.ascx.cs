...
namespace Mediachase.Ibn.Web.UI
{
	public partial class SelectPopup : System.Web.UI.UserControl
	{
        ...
        /// <summary>
        /// Gets or sets the _owner control.
        /// </summary>
        /// <value>The _owner control.</value>
...
*/
        ...
        /// <summary>
        /// Handles the ValueChanged event of the hfClassName control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Handles the TextChanged event of the tbMain control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
