...
<asp:DataGrid runat="server" ID="grdMain" AutoGenerateColumns="false" Width="100%" BorderWidth="1" BorderColor="lightgray"
	CellPadding="4" GridLines="Horizontal" AllowPaging="false" AllowSorting="false"
	OnDeleteCommand="grdMain_DeleteCommand" OnItemDataBound="grdMain_RowDataBound">
	<Columns>
		...
		<asp:TemplateColumn>
			<ItemTemplate>
				...
				<asp:ImageButton ID="ibDelete" Runat="server" CommandName="Delete" CommandArgument='<%# Eval("Id") %>' ImageUrl="~/Apps/MetaDataBase/Images/delete.gif" ToolTip="<%$Resources : GlobalMetaInfo, Delete%>" Width="16" Height="16" Visible='<%# Eval("CanDelete")%>'></asp:ImageButton> 
			</ItemTemplate>
