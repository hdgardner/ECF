					...
					<asp:DataGrid runat="server" ID="grdMain" AutoGenerateColumns="false" Width="100%" 
						...
						<Columns>
							...
							<asp:TemplateColumn>
								...
								<HeaderStyle CssClass="ibn-vh" Width="50px" />
								<ItemTemplate>
									<asp:ImageButton id="ibEdit" runat="server" ImageUrl="../../Images/edit.gif" ToolTip="<%$Resources : GlobalMetaInfo, Edit%>" Width="16" Height="16" CommandName="Edit" causesvalidation="False" CommandArgument='<%# Eval("Id") %>'></asp:ImageButton>
									&nbsp;
									<asp:ImageButton ID="ibDelete" Runat="server" ImageUrl="../../Images/delete.gif" ToolTip="<%$Resources : GlobalMetaInfo, Delete%>" Width="16" Height="16" CommandName="<%$Resources : GlobalMetaInfo, Delete%>" CommandArgument='<%# Eval("Id") %>'></asp:ImageButton> 
								</ItemTemplate>
								<EditItemTemplate>
									<asp:ImageButton id="ibSave" runat="server" ToolTip="<%$Resources : GlobalMetaInfo, Save%>" ImageUrl="../../Images/SaveItem.gif" commandname="Update" causesvalidation="True" CommandArgument='<%# Eval("Id") %>'></asp:ImageButton>
									&nbsp;
									<asp:imagebutton id="ibCancel" runat="server" ToolTip="<%$Resources : GlobalMetaInfo, Cancel%>" ImageUrl="../../Images/cancel.gif" commandname="Cancel" causesvalidation="False">
									</asp:imagebutton>
								</EditItemTemplate>
							</asp:TemplateColumn>
						</Columns>
