...
{
	public partial class JurisdictionGroupEdit : OrderBaseUserControl
	{
		private const string _JurisdictionDtoEditSessionKey = "ECF.JurisdictionGroupDto.Edit";
		...
		{
            //first check for permissions for create or edit permissions. If JurisdictionGroupId > 0, its an edit
