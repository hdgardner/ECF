...
namespace Mediachase.Commerce.Manager.Order.Payments
{
	...
	/// </summary>
	public partial class PaymentMethods : OrderBaseUserControl
	{
        /// <summary>
		...
		{
			PaymentMethodDto dto = PaymentManager.GetPaymentMethods(LanguageCode, true);
			if (dto.PaymentMethod != null)
			{
				DataView view = dto.PaymentMethod.DefaultView;
				view.Sort = sortExpression;
				MyListView.DataSource = view;
			}

			MyListView.CurrentListView.PrimaryKeyId = EcfListView.MakePrimaryKeyIdString("PaymentMethodId", "LanguageId");
			MyListView.DataBind();
		}
	}
}
