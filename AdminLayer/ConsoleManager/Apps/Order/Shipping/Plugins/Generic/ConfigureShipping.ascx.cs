...
namespace Mediachase.Commerce.Manager.Order.Shipping.Plugins.Generic
{
	/// <summary>
	///		Summary description for ConfigureShipping.
	/// </summary>
	public partial class ConfigureShipping : OrderBaseUserControl, IGatewayControl
	{
		...
		public void BindData()
		{
			...
			{
				//foreach (ShippingMethodDto.ShippingMethodParameterRow parameterRow in _ShippingMethodDto.ShippingMethodParameter.Rows)
				//{
