                        ...
                        <ComponentArt:Grid Debug="false" AllowEditing="true" EnableViewState="true" RunningMode="Callback" 
                            ...
                            <ClientTemplates>
                                ...
                                <ComponentArt:ClientTemplate ID="HyperlinkTemplate">
                                    <a href="javascript:RegionsGrid.edit(RegionsGrid.getItemFromClientId('## DataItem.Arguments ##'));"><img alt="edit" src="../../../App_Themes/Default/Images/edit.gif" /></a> | <a href="javascript:RegionsGrid.deleteItem(RegionsGrid.getItemFromClientId('## DataItem.ClientId ##'))"><img alt="delete" src="../../../App_Themes/Main/Images/toolbar/delete.gif" /></a>
                                </ComponentArt:ClientTemplate>
                                ...
                                <ComponentArt:ClientTemplate ID="LoadingFeedbackTemplate">
                                  ...
                                  <ComponentArt:ClientTemplate Id="EditTemplate">
                                    <a href="javascript:RegionsGrid.edit(RegionsGrid.getItemFromClientId('## DataItem.ClientId ##'));"><img alt="edit" src="../../../App_Themes/Default/Images/edit.gif" /></a> | <a href="javascript:RegionsGrid.deleteItem(RegionsGrid.getItemFromClientId('## DataItem.ClientId ##'))"><img alt="delete" src="../../../App_Themes/Main/Images/toolbar/delete.gif" /></a>
                                  </ComponentArt:ClientTemplate>
