...
<div id="DataForm">
    <table class="DataForm">
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, From_Lowercase %>"/>&nbsp;<asp:TextBox runat="server" ID="ZipCodeStart"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, To_Lowercase %>"/>&nbsp;<asp:TextBox runat="server" ID="ZipCodeEnd"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="FormLabelCell">
