...
<div id="DataForm">
    <table width="100%">
        <tr>
                    ...
                    <tr>
                        ...
                        <td class="FormFieldCell">
                            <ComponentArt:ComboBox ID="CustomerName" runat="server" RunningMode="Callback" DataTextField="Name"
                                ...
                                ItemHoverCssClass="comboItemHover" SelectedItemCssClass="comboItemHover" DropHoverImageUrl="App_Themes/Main/images/combobox/drop_hover.gif"
                                DropImageUrl="App_Themes/Main/images/combobox/drop.gif" TextBoxClientTemplateId="itemTemplate">
                                <ClientTemplates>
                                    <ComponentArt:ClientTemplate ID="itemTemplate" runat="server">
                                        <a href="javascript:CSManagementClient.ChangeView('Profile', 'Account-View','id=## DataItem.get_value() ##');">## DataItem.get_text() ##</a>
            ...
            <td valign="top">           
                <asp:UpdatePanel runat="server" ID="OrderSummaryPanel" ChildrenAsTriggers="true" UpdateMode="Always" EnableViewState="true" RenderMode="Inline">
	                <ContentTemplate>
