        ...
        <asp:TableRow>
            <asp:TableCell>
                <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpCtrl" 
                    ...
                    <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/document_add.png") %>' width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Add_New_File %>"/></div></ShowTextTemplate>
                    ...
                    <UploadTextTemplate><img src='<%= Page.ResolveUrl("~/App_Themes/Default/Images/Uploader/publish.gif") %>' width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Upload_File %>"/></span></UploadTextTemplate>
        ...
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    <tr>
                        <td align="left">
                            <core:FileList ID="FilesControl" runat="server" Folder='<%# Mediachase.Web.Console.Common.ManagementHelper.GetImportExportFolderPath("tax") %>' GridAppId="Order" GridViewId="FilesList-Import" SelectedBtnId='<%# btnImport.ClientID %>' />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
