...
{
    public partial class BestSellersReport : System.Web.UI.UserControl
    {
        /// <summary>
        ...
        private void BindReport()
        {
            ...
            cmd.CommandText = "[ecf_reporting_ProductBestSellers]";
            ...
            cmd.TableMapping = DataHelper.MapTables("BestSellersReport");
            cmd.DataSet = new Mediachase.Web.Console.Reporting.DataSources.ProductDataSet();
            DataResult results = DataService.LoadDataSet(cmd);

            ReportDataSource source = new ReportDataSource();
            source.Name = "BestSellersReport";
            source.Value = ((Mediachase.Web.Console.Reporting.DataSources.ProductDataSet)results.DataSet).BestSellersReport;
