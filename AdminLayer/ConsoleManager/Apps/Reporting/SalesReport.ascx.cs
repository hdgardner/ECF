...
namespace Mediachase.Commerce.Manager.Apps.Reporting
{
    public partial class SalesReport : System.Web.UI.UserControl
    {
        ...
        private void BindReport()
        {
            ...
            cmd.CommandText = "[ecf_reporting_SaleReport]";
            ...
            cmd.TableMapping = DataHelper.MapTables("SalesReport");
            cmd.DataSet = new SalesDataSet();
            DataResult results = DataService.LoadDataSet(cmd);

            ReportDataSource source = new ReportDataSource();
            source.Name = "SalesReport";
            source.Value = ((SalesDataSet)results.DataSet).SalesReport;
