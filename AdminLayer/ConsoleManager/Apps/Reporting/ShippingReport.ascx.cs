...
{
    public partial class ShippingReport : System.Web.UI.UserControl
    {
        /// <summary>
        ...
        private void BindReport()
        {
            ...
            cmd.CommandText = "[ecf_reporting_Shipping]";
            ...
            cmd.TableMapping = DataHelper.MapTables("ShippingReport");
            cmd.DataSet = new Mediachase.Web.Console.Reporting.DataSources.SalesDataSet();
            DataResult results = DataService.LoadDataSet(cmd);

            ReportDataSource source = new ReportDataSource();
            source.Name = "ShippingReport";
            source.Value = ((Mediachase.Web.Console.Reporting.DataSources.SalesDataSet)results.DataSet).ShippingReport;
