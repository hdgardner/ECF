...
<script type="text/javascript">
    function ecf_UpdateCurrencyRateDialogControl(val)
    {
                    ...
                    <table class="DataForm">
                        ...
                        <tr>
                            ...
                            <td class="FormFieldCell">
                                ...
                                <asp:RangeValidator ID="RangeValidator2" runat="server" ValidationGroup="CurrencyRateValidationGroup" ControlToValidate="tbRate" Display="Dynamic" ErrorMessage="*" Type="Double" MinimumValue="0" MaximumValue="10000"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
                            ...
                            <td class="FormFieldCell">
                                ...
                                <asp:RangeValidator ID="RangeValidator1" runat="server" ValidationGroup="CurrencyRateValidationGroup" ControlToValidate="tbAverageRate" Display="Dynamic" ErrorMessage="*" Type="Double" MinimumValue="0" MaximumValue="10000"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
