...
<script type="text/javascript">
    ...
    {
        var list = $get('<%= SaleTypeFilter.ClientID %>');
        if(list != null)
        {
            var field = $get('<%= SelectedSaleTypeField.ClientID %>');
            if(field != null)
    ...
    {
        var list = $get('<%= CurrencyFilter.ClientID %>');
        if(list != null)
        {
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="padding: 1px;" align="left" valign="middle">
                    <!-- Content Area -->
                    <asp:HiddenField runat="server" id="SelectedSaleTypeField"/>
                    ...
                    <table class="DataForm">
                        <tr>
                           ...
                           <td class="FormFieldCell">
                                <asp:DropDownList runat="server" ID="SaleTypeFilter" onchange="javascript:UpdateSaleType();" DataValueField="SaleTypeId" DataTextField="SaleTypeName"></asp:DropDownList>
                           </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
                        ...
                        <tr>
                            ...
                            <td class="FormFieldCell">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ValidationGroup="SalePriceDetails" ControlToValidate="UnitPrice" Display="Dynamic" ErrorMessage="*" />
                                <asp:RangeValidator ID="RangeValidator2" runat="server" ValidationGroup="SalePriceDetails" ControlToValidate="UnitPrice" Display="Dynamic" ErrorMessage="*" Type="Currency" MinimumValue="0" MaximumValue="1000000000"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
                           ...
                           <td class="FormFieldCell">
                                <asp:DropDownList runat="server" ID="CurrencyFilter" onchange="javascript:UpdateCurrency();" DataValueField="CurrencyCode" DataTextField="Name"></asp:DropDownList>
                           </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
                            ...
                            <td class="FormFieldCell">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ValidationGroup="SalePriceDetails" ControlToValidate="MinQuantity" Display="Dynamic" ErrorMessage="*" />
                                <asp:RangeValidator ID="RangeValidator3" runat="server" ValidationGroup="SalePriceDetails" ControlToValidate="MinQuantity" Display="Dynamic" ErrorMessage="*" Type="Double" MinimumValue="0" MaximumValue="10000"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="FormLabelCell">
            ...
            <tr>
                <td colspan="2" style="background-image: url(App_Themes/Main/images/dialog/bottom_content.gif); height: 41px; padding-right: 10px;" align="right">
                    <asp:Button runat="server" ID="SaveChangesButton" ValidationGroup="SalePriceDetails" OnClick="SaveChangesButton_Click" Text="<%$ Resources:CatalogStrings, Entry_Save_Changes %>" />
                </td>
            </tr>
        </table>
    </ContentTemplate>
