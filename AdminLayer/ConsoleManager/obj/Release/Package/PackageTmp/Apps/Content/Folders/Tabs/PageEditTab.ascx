...
<div id="DataForm">
    <table class="DataForm" width="650"> 
        <tr>
            <td class="FormLabelCell"><asp:Literal ID="NameLiteral" runat="server" Text='<%$ Resources:Admin, Name %>'></asp:Literal>:</td>
        ...
        <tr id="ParentFolderRow" runat="server" visible="false">
            <td class="FormLabelCell" nowrap><asp:Literal ID="ParentFolderLiteral" runat="server" Text='<%$ Resources:Admin, ParentFolder %>'></asp:Literal>:</td>
        ...
        <tr id="MasterPageRow" runat="server" visible="false">
            <td class="FormLabelCell"><asp:Literal ID="MasterPageLiteral" runat="server" Text='<%$ Resources:Admin, MasterPage %>'></asp:Literal>:</td>
            <td class="FormFieldCell"><asp:TextBox runat="server" ID="MasterPageText" Width="220"></asp:TextBox></td>
        </tr>
        <tr id="DefaultRow" runat="server">
            <td class="FormLabelCell" nowrap><asp:Literal ID="IsDefaultLiteral" runat="server" Text='<%$ Resources:Admin, DefaultPage %>'></asp:Literal>:</td>
        ...
        <tr>
            <td class="FormLabelCell"><asp:Literal ID="TitleLiteral" runat="server" Text='<%$ Resources:Admin, Title %>'></asp:Literal>:</td>
        ...
        <tr>
            <td class="FormLabelCell"><asp:Literal ID="KeywordsLiteral" runat="server" Text='<%$ Resources:Admin, KeyWords %>'></asp:Literal>: <br />
        ...
        <tr>
            <td class="FormLabelCell"><asp:Literal ID="MetaDescriptionLiteral" runat="server" Text='<%$ Resources:Admin, Description %>'></asp:Literal>: <br />
