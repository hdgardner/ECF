...
<div id="DataForm">
    <table class="DataForm" width="650">
        <tr>
            ...
            <td class="FormFieldCell">
                ...
                <asp:RequiredFieldValidator runat="server" ID="NameValidation" ControlToValidate="Name" 
                    ErrorMessage="<%$ Resources:ContentStrings, Menu_Item_Name_Required %>" Display="None"></asp:RequiredFieldValidator>
        ...
        <tr>
            <td class="FormLabelCell" nowrap><asp:Label ID="Literal1" runat="server" Text='<%$ Resources:Admin, Tooltip %>'></asp:Label> <asp:Label runat="server" ID="TooltipLanguageCode"></asp:Label>:</td>
        ...
        <tr>
            <td class="FormLabelCell"><asp:Label ID="Literal3" runat="server" Text='<%$ Resources:Admin, Active %>'></asp:Label>:</td>
        ...
        <tr>  
            ...
            <td class="FormFieldCell">
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" Type="Integer" ControlToValidate="SortOrder" 
                    MinimumValue="-1000000" MaximumValue="1000000" 
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                    ...
                    <asp:RadioButton runat="Server" ID="rbNavigation" GroupName="CommandType" onclick=<%#"CSContentClient.EditMenuCommand(3,'" + this.ClientID + "');" %>
                        Text="<%$ Resources:Admin, CommandNavigation %>"/>           
            </td>
        </tr>
        <tr>
            <td colspan="2" class="FormSpacerCell">
        ...
        <tr id="trCommand">
            <td class="FormLabelCell">
                <div runat="server" id="CommandTitle" name="CommandTitle" style="display: none;">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:Admin, Command %>" />:</div>
                <div runat="server" id="NavigationTitle" name="NavigationTitle" style="display:none;"> 
                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:Admin, CommandNavigation %>" />: <br />
                    <div style="height: 3px;">&nbsp</div>
                    <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:Admin, Parameters %>" />: <br />
                </div>
            </td>
            <td class="FormLabelCell">
                ...
                <div runat="server" id="NavigationText" name="NavigationText" style="display:none;">
                    ...
                    <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources:Admin, ParametersValue %>" />: <br />
        ...
        <tr>
            <td class="FormLabelCell"><asp:Label ID="Label2" runat="server" Text='<%$ Resources:Admin, Parent %>'></asp:Label>:</td>
