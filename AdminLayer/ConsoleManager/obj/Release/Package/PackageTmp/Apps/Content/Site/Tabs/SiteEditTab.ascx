...
<div id="DataForm">
    <table>
        <tr>
            ...
            <td class="FormFieldCell">
                ...
                <asp:RequiredFieldValidator runat="server" ID="NameValidation" ControlToValidate="SiteName" 
                    ErrorMessage="<%$ Resources:ContentStrings, Site_Name_Required %>" Display="None"></asp:RequiredFieldValidator>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label runat="server" Text='<%$ Resources:Admin, Title %>'></asp:Label>:</td>
            <td class="FormFieldCell">
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label runat="server" Text='<%$ Resources:Admin, SiteAddress %>'></asp:Label>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label ID="Label1" runat="server" Text='<%$ Resources:Admin, EMail %>'></asp:Label>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label ID="Label7" runat="server" Text='<%$ Resources:Admin, Telephone %>'></asp:Label>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label ID="Label9" runat="server" Text='<%$ Resources:Admin, Address %>'></asp:Label>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label ID="Label11" runat="server" Text='<%$ Resources:Admin, KeyWords %>'></asp:Label>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Label ID="Label13" runat="server" Text='<%$ Resources:Admin, Description %>'></asp:Label>
