	...
	<ProgressTemplate>
		<div style="height: 20%; width: 30%; position: absolute; left: 35%; top: 40%; z-index: 1000; background-color: White; border: solid 1px #AAAAAA;">
			<div style="position: absolute; left: 45%; top: 40%;">
				<img src='<%= this.ResolveClientUrl("~/App_Themes/Default/images/Shell/loading_rss.gif") %>' alt='loading' height="16" width="16" />
			</div>
		</div>
	</ProgressTemplate>
</asp:UpdateProgress>
...
<asp:UpdatePanel runat="server" ID="panelMainListView" ChildrenAsTriggers="true" UpdateMode="Conditional" EnableViewState="true" RenderMode="Inline">
	<ContentTemplate> 
	    <custom:EcfListView runat="server" ID="MainListView" SkinID="EcfDefaultGrid" InsertItemPosition="FirstItem">
                                ...
                                <div style="float:right; padding-right:5px;padding-top:7px;">
                                    <asp:DataPager ID="mainListViewPager2" runat="server" PagedControlID="MainListView">
                                        ...
                                        <asp:TemplatePagerField>
                                            <PagerTemplate>
                                                (<asp:Label runat="server" ID="TotalItemsLabel" Text="<%# Container.TotalRowCount%>" /> items)&nbsp;|&nbsp;<asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Page %>"/>
                                            </PagerTemplate>
                                        </asp:TemplatePagerField>
                                        <asp:NextPreviousPagerField ShowPreviousPageButton="true" ButtonType="Image" ShowNextPageButton="false" ShowLastPageButton="false" PreviousPageImageUrl="~/App_Themes/Main/images/grid/pager/prev.gif" />
                                        <asp:NumericPagerField/>                                      
                                        <asp:NextPreviousPagerField ShowPreviousPageButton="false" ButtonType="Image" ShowNextPageButton="true" ShowLastPageButton="false" NextPageImageUrl="~/App_Themes/Main/images/grid/pager/next.gif" />
                                        </Fields>
                                    </asp:DataPager>
                                </div>
                            </div>
            ...
            <ItemTemplate>
                <tr id="itemTRow" runat="server" class='<%# ((ListViewDataItem)Container).DisplayIndex % 2 == 0 ? "Row" : "AlternatingRow" %>'>
                    <%--   Data-bound content. --%>
                </tr>
            </ItemTemplate>
            <InsertItemTemplate>
        ...
        <!-- TargetControlID="MainListView$lvTable" -->
    </ContentTemplate>
</asp:UpdatePanel>