            ...
            <td class="FormLabelCell">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="FormFieldCell">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:SharedStrings, Name_Required %>"
                                Font-Size="9pt" Font-Name="verdana" Display="None" ControlToValidate="tbName" />
                            <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="vceRequiredFieldValidator1"
                                Width="220" TargetControlID="RequiredFieldValidator1" HighlightCssClass="FormHighlight" />
                            ...
                            <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="vceRegularExpressionValidator1"
                                Width="220" TargetControlID="RegularExpressionValidator1" HighlightCssClass="FormHighlight" />
                    ...
                    <tr>
                        ...
                        <td class="FormFieldCell">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources:SharedStrings, Friendly_Name_Required %>"
                                Font-Size="9pt" Font-Name="verdana" Display="None" ControlToValidate="tbFriendlyName" />
                            <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="vce" Width="220" TargetControlID="RequiredFieldValidator2"
                    ...
                    <tr>
                        ...
                        <td class="FormFieldCell">
                            <asp:CheckBox runat="server" ID="chkSaveHistory"></asp:CheckBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr runat="server" id="SearchProperties">
                        ...
                        <td class="FormFieldCell">
                            <table>
                                <tr>
                                    <td colspan="2"><asp:CheckBox runat="server" ID="chkAllowSearch"></asp:CheckBox></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><asp:CheckBox runat="server" ID="IndexStored" Text="<%$ Resources:CoreStrings, MetaData_Store_The_Value %>" /></td>
                                </tr>                                
                                <tr>
                                    <td><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:CoreStrings, MetaData_Indexing_Option %>"/>:
                                    </td>
                                    <td>
                                        <asp:DropDownList runat="server" ID="IndexOptionsList">
                                            <asp:ListItem Value="tokenized" Text="<%$ Resources:CoreStrings, MetaData_Tokenized %>" />
                                            <asp:ListItem Value="untokenized" Text="<%$ Resources:CoreStrings, MetaData_Not_Tokenized %>" />
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
				                    ...
				                    <ProgressTemplate>
					                    <div class="upProgressMain">
						                    <div class="upProgressCenter">
							                    <img align='absmiddle' border='0' src='<%# Mediachase.Ibn.Web.UI.CHelper.GetAbsolutePath("~/App_Themes/Default/Images/Shell/loading_rss.gif") %>' />&nbsp;Loading...
						                    </div>
					                    </div>
				                    </ProgressTemplate>
			                    </asp:UpdateProgress>
