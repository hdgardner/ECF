...
<%@ Register TagPrefix="core" TagName="CalendarDatePicker" src="~/Apps/Core/Controls/CalendarDatePicker.ascx" %>
   ...
   <tr>  
     ...
     <td class="FormFieldCell">
        ...
        <asp:RequiredFieldValidator runat="server" ID="NameRequired" ControlToValidate="DTClientControl1" Display="None" ErrorMessage="<%$ Resources:SharedStrings, Required_Field_Missing %>" />
