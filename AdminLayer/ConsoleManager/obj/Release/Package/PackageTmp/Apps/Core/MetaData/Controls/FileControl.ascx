            ...
            <asp:TableRow>
                <asp:TableCell>
                    <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpMetaValueCtrl" 
                        ...
                        <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src="../../../App_Themes/Default/Images/Uploader/document_add.png" width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Add_New_File%>" /></div></ShowTextTemplate>
                        <HideTextTemplate><img src="../../../App_Themes/Default/Images/Uploader/scrollup_hover.gif" width="16" height="16" border="0" title="Hide" /><span class="FileUploadHideBlock">&nbsp;<asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Hide_Panel%>" /></span></HideTextTemplate>
                        <UploadTextTemplate><img src="../../../App_Themes/Default/Images/Uploader/publish.gif" width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:SharedStrings, Upload_Files%>" /></span></UploadTextTemplate>
                        ...
                        <tr>
                            <td align="right" visible="false">
                                <mc:UploadedFileList ID="fvControl" runat="server" FileUploadControlID="FileUpMetaValueCtrl" ClientBinderProvider="XML"  >
                                    <DeleteCommandTemplate><img src="../../../App_Themes/Default/Images/Uploader/delete2.png" width="16px" height="16px" border="0" title="Delete" align="absmiddle" /></DeleteCommandTemplate>
                                </mc:UploadedFileList>
                            </td>
                        </tr>
                    </table>
