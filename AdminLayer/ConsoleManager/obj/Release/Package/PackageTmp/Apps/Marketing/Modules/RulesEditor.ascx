...
<table>
    <tr>
        <td valign="top">
            <asp:Button runat="server" ID="NewConditionButton" Text="New Condition" OnClientClick="<%#GetJSCommandDialog(0) %>" />
        </td>   
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
            ...
            <asp:UpdatePanel runat="server" ID="ExpressionsPanel" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Repeater runat="server" ID="RulesList" DataMember="Expression" OnItemDataBound="RulesList_ItemDataBound" OnItemCommand="RulesList_ItemCommand">
                        <ItemTemplate>                            
                            <asp:ImageButton runat="server" ID="EditControl" AlternateText="Modify Condition" CommandArgument='<%#Eval("ExpressionId") %>' ImageUrl="~/App_Themes/Default/Images/edit.gif" />
