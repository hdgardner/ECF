  ...
  <table class="DataForm">
   <tr>
     ...
     <td class="FormFieldCell">
        <asp:TextBox runat="server" Width="250" ID="tbExpressionName"></asp:TextBox><br />
        <asp:Label CssClass="FormFieldDescription" runat="server" Text="<%$ Resources:MarketingStrings, Expression_Name_Enter %>"></asp:Label>
        <asp:RequiredFieldValidator runat="server" ID="ExpressionNameRequired" ControlToValidate="tbExpressionName" Display="None" ErrorMessage="<%$ Resources:MarketingStrings, Expression_Name_Required %>" />
        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="ExpressionNameRequiredE" Width="220" TargetControlID="ExpressionNameRequired" HighlightCssClass="FormHighlight"/>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="FormFieldCell">
        <asp:TextBox runat="server" ID="tbDescription" Rows="10" TextMode="MultiLine" Columns="150"></asp:TextBox><br />
