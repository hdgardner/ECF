  ...
  <table class="DataForm"> 
   <tr>
     ...
     <td class="FormFieldCell">
        <asp:TextBox runat="server" Width="250" ID="PolicyName"></asp:TextBox><br />
        <asp:Label CssClass="FormFieldDescription" runat="server" Text="<%$ Resources:MarketingStrings, Policy_Name_Enter %>"></asp:Label>
        <asp:RequiredFieldValidator runat="server" ID="PolicyNameRequired" ControlToValidate="PolicyName" Display="None" ErrorMessage="<%$ Resources:MarketingStrings, Policy_Name_Required %>" />
        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="PolicyNameRequiredE" Width="220" TargetControlID="PolicyNameRequired" HighlightCssClass="FormHighlight"/>
     </td>
   </tr>
   <tr>
     <td class="FormLabelCell"><asp:Label ID="Label2" runat="server" Text="<%$ Resources:MarketingStrings, Policy_Status %>"></asp:Label>:</td>
     <td class="FormFieldCell">
        <asp:TextBox runat="server" Width="250" ID="tbStatus"></asp:TextBox><br />
        ...
        <asp:RequiredFieldValidator runat="server" ID="PolicyStatusRequired" ControlToValidate="tbStatus" Display="None" ErrorMessage="<%$ Resources:MarketingStrings, Policy_Status_Required %>" />
        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="PolicyStatusRequiredE" Width="220" TargetControlID="PolicyStatusRequired" HighlightCssClass="FormHighlight"/>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="FormFieldCell">
         ...
         <asp:RequiredFieldValidator runat="server" ID="PolicyExpressionValidator" ControlToValidate="ddlExpression" Display="None" ErrorMessage="<%$ Resources:MarketingStrings, Policy_Expression_Required %>" />
        <ajaxToolkit:ValidatorCalloutExtender runat="Server" ID="PolicyExpressionValidatorE" Width="220" TargetControlID="PolicyExpressionValidator" HighlightCssClass="FormHighlight"/>
     </td>
   </tr>
   <tr>
     <td colspan="2" class="FormSpacerCell"></td>
