...
<div style="padding: 15px; border-bottom: 1px solid #adadad" class="ibn-light text">
	...
	<div style="font-weight: bold; width: 130px; float: left;"><asp:Literal ID="Literal2" runat="server" Text='<%$Resources : MetaForm, LabelWidth %>' />:</div>
	<asp:TextBox ID="txtLabelWidth" runat="server" Width="40px"></asp:TextBox>&nbsp;px
	<asp:CompareValidator ID="cv2" runat="server" Display="Static" ErrorMessage="*" ControlToValidate="txtLabelWidth"
		ValueToCompare="0" Operator="GreaterThanEqual" Type="Integer"></asp:CompareValidator>
</div>
