...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed">
	<tr>
		...
		<td width="20px" runat="server" id="tdSelect">
			<asp:ImageButton Runat="server" ToolTip="Select" Width="16" Height="16" ID="ibSelect" ImageAlign="AbsMiddle"></asp:ImageButton> 
		</td>
		<td width="20px" runat="server" id="tdClear">
			<asp:ImageButton Runat="server" ToolTip="Clear" Width="16" Height="16" ID="ibClear" ImageAlign="AbsMiddle" OnClick="ibClear_Click" CausesValidation="false"></asp:ImageButton> 
		</td>
		<td width="20px">
