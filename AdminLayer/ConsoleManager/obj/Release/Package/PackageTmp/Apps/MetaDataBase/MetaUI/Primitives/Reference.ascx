<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Ibn.Web.UI.Controls.Util.BaseType" ClassName="Mediachase.Ibn.Web.UI.MetaUI.Primitives.ReferenceControl" %>
...
<script language="c#" runat="server">
    protected string GetValue(MetaObject DataItem, string FieldName)
    {
        ...
        if (DataItem != null && DataItem.Properties[FieldName].Value!=null)
        {
			...
			MetaObject obj = new MetaObject(mc, (int)DataItem.Properties[FieldName].Value);
