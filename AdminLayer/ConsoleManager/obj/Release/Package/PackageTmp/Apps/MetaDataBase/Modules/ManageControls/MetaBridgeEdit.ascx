						...
						<fieldset>
							...
							<table cellpadding="5" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								...
								<tr>
									...
									<td style="width:16px" align="left">
										<img src='<%=Page.ResolveClientUrl("../../images/resource.gif")%>' title='<%=GetGlobalResourceObject("GlobalMetaInfo", "ResourceTooltip").ToString()%>' 
											onclick="SetText('<%=txtField1FriendlyName.ClientID%>','{ResourceName:ResourceKey}','<%=vldField1FriendlyName_Required.ClientID %>')" style="width:16px; height:16px" alt=""/>
									</td>
									<td width="16px">
						...
						<fieldset style="margin-top:5px;">
							...
							<table cellpadding="5" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								...
								<tr>
									...
									<td width="16px">
										<img src='<%=Page.ResolveClientUrl("../../images/resource.gif")%>' title='<%=GetGlobalResourceObject("GlobalMetaInfo", "ResourceTooltip").ToString()%>' 
											onclick="SetText('<%=txtField2FriendlyName.ClientID%>','{ResourceName:ResourceKey}','<%=vldField2FriendlyName_Required.ClientID %>')" style="width:16px; height:16px" alt="" />
									</td>
									<td width="16px">
