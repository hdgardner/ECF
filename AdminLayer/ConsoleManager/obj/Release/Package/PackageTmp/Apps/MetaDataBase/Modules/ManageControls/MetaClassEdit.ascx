						...
						<fieldset style="margin:0px;padding:2px;width:100%;">
							...
							<table cellpadding="5" cellspacing="0" border="0" class="ibn-propertysheet" width="100%">
								...
								<tr>
									...
									<td width="16px">
										<img src='<%=ResolveClientUrl("~/Apps/MetaDataBase/Images/resource.gif")%>' title='<%=GetGlobalResourceObject("GlobalMetaInfo", "ResourceTooltip").ToString()%>'
								...
								<tr>
									<td class="ibn-label" width="120px">
										<asp:Literal ID="Literal4" runat="server" Text="<%$Resources : GlobalMetaInfo, Type%>" />:
									</td>
									<td>
										<asp:DropDownList Runat="server" ID="ddlOwnerType" Width="100%"></asp:DropDownList>
									</td>
									<td></td>
									<td></td>
								</tr>
						...
						<fieldset style="margin:0;padding:2px;width:100%">
							...
							<table cellpadding="3" cellspacing="1" border="0" class="ibn-propertysheet" width="100%">
								...
								<tr>
									...
									<td width="16px">
										<img src='<%=ResolveClientUrl("~/Apps/MetaDataBase/Images/resource.gif")%>' title='<%=GetGlobalResourceObject("GlobalMetaInfo", "ResourceTooltip").ToString()%>' 
											onclick="SetText('<%=txtFieldFriendlyName.ClientID%>','{ResourceName:ResourceKey}','<%=vldFieldFriendlyName_Required.ClientID%>')" style="width:16px; height:16px" alt=""/>
									</td>
									<td width="16px">
