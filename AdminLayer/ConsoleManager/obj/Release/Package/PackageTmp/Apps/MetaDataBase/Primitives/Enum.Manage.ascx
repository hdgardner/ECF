...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="ibn-propertysheet" style="table-layout:fixed;">
	...
	<tr>
		...
		<td align="left" style="width:16px">
			<img src='<%=Mediachase.Ibn.Web.UI.CHelper.GetAbsolutePath("/Apps/MetaDataBase/images/resource.gif")%>' title='<%=GetGlobalResourceObject("GlobalMetaInfo", "ResourceTooltip").ToString()%>' alt='' 
