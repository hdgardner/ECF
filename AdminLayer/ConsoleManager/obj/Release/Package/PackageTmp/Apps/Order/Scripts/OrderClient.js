...
function Mediachase_OrderClient()
{
    ...
    // Method Mappings
    this.NewPurchaseOrder = function(source) {
        var curFilter = CSManagementClient.QueryString("filter");
        var curClass = CSManagementClient.QueryString("class");
        CSManagementClient.ChangeView('Order', 'PurchaseOrder-New', 'filter=' + curFilter + '&class=' + curClass);
    };  

    this.NewPaymentPlan = function(source) {
        var curFilter = CSManagementClient.QueryString("filter");
        var curClass = CSManagementClient.QueryString("class");
        CSManagementClient.ChangeView('Order', 'PaymentPlan-New', 'filter=' + curFilter + '&class=' + curClass);
    };
    ...
    this.NewPackage = function() {
        CSManagementClient.ChangeView('Order', 'Package-Edit');
    };
    ...
    this.EditPackage = function(params) {
        ...
        CSManagementClient.ChangeView('Order', 'Package-Edit', 'PackageId=' + packageId);
    };
    ...
    this.ViewOrder2 = function(className, id, customerid) {
        CSManagementClient.ChangeView('Order', className + '-View', 'class=' + className + '&id=' + id + '&customerid=' + customerid);
    };
