...
<div class="editDiv">
<ecf:EditViewControl AppId="Order" ViewId="Package-Edit" id="ViewControl" runat="server" MDContext="<%# Mediachase.Commerce.Orders.OrderContext.MetaDataContext %>"></ecf:EditViewControl>
