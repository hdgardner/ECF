    ...
    <table class="DataForm">
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                ...
                <asp:RangeValidator ID="SortOrderRangeValidator" runat="server" Type="Integer" ControlToValidate="SortOrder" MinimumValue="-1000000" MaximumValue="1000000" ErrorMessage="<%$ Resources:SharedStrings, Sort_Order_Invalid %>" Display="Dynamic"></asp:RangeValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="FormSpacerCell">
