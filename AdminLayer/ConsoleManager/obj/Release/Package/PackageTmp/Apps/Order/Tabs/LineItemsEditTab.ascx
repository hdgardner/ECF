...
<div id="DataForm">
 <table width="100%" class="DataForm"> 
     ...
     <tr>
        <td class="wh100">
            <ComponentArt:Grid Debug="false" AllowEditing="true" RunningMode="Client" AutoFocusSearchBox="false" ShowHeader="false" ShowFooter="false" SkinID="Inline" runat="server" ID="LineItemsGrid" 
                ...
                <ClientTemplates>
                      <ComponentArt:ClientTemplate Id="EditTemplate">
                        <a href="javascript:LineItem_Edit(LineItemsGrid.getItemFromClientId('## DataItem.ClientId ##').getMember('LineItemId').get_text());"><img src="../../../App_Themes/Default/Images/edit.gif" /></a> | <a href="javascript:LineItemsGrid_Delete(LineItemsGrid.getItemFromClientId('## DataItem.ClientId ##'));"><img alt="delete" src="../../../App_Themes/Main/Images/toolbar/delete.gif" /></a>
