    ...
    <table class="DataForm">
        <tr>
            ...
            <td class="FormFieldCell">
                <asp:TextBox runat="server" ID="tbName" Width="350px"></asp:TextBox>
        ...
        <tr>  
            ...
            <td class="FormFieldCell">
                ...
                <ajaxToolkit:ValidatorCalloutExtender runat="server" ID="ValidatorCalloutExtender1" Width="220" TargetControlID="RangeValidator1" HighlightCssClass="FormHighlight" />
            </td>
        </tr>
        <tr>
