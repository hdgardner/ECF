<%@ Page Language="C#" AutoEventWireup="true" Inherits="Mediachase.Commerce.Manager.Login"
    Theme="Main" CodeBehind="Login.aspx.cs" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mediachase Commerce Manager 5.0 Login Page</title>
...
<body>
    ...
    <div style="width: 100%; height: 50px; background-image: url(<%=ResolveClientUrl("~/App_Themes/Default/Images/Shell/up_bg.gif") %>);
        ...
        <div style="float: left; padding: 15px 0 0 10px;">
            <asp:Label ID="lblPageTitle" runat="server" CssClass="ibn-pagetitle" Text="Operational Access"></asp:Label>
        </div>
            ...
            <table cellspacing="0" cellpadding="0" align="left">
                ...
                <tr valign="top">
                    <td width="550">
                        <asp:Panel ID="LoginPanel" runat="server" DefaultButton="LoginCtrl$LoginButton">
                            <asp:Login ID="LoginCtrl" runat="server" TitleText="">
                                <LayoutTemplate>
                                                    ...
                                                    <table class="login" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox Width="300px" ID="UserName" runat="server"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox Width="300px" ID="Password" runat="server" TextMode="Password"></asp:TextBox>
                ...
                <tr>
                    <td class="text">
                        <p>
                            <br>
                            Note: You MUST use Microsoft Internet Explorer (IE) Version 7.0 or higher to use the commerce manager tools and functions.</p>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="LoginFooter">
        <asp:HyperLink Target="_blank" runat="server" NavigateUrl="http://www.mediachase.com"><%=Mediachase.Commerce.FrameworkContext.ProductName%></asp:HyperLink>
        <br />
        Version:
        <%=Mediachase.Commerce.FrameworkContext.ProductVersionDesc%><br /><br />
        &copy; 2008-2009 Mediachase Ltd.  All Rights Reserved.
    </div>
    </form>
</body>
</html>
