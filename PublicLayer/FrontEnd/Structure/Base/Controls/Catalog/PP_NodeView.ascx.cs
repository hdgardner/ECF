...
public partial class Controls_Catalog_PP_NodeView : System.Web.UI.UserControl, IPropertyPage
{
    /// <summary>
    ...
    {
        get { return "Displays catalog node like category on the page using the template specified."; }
    }
