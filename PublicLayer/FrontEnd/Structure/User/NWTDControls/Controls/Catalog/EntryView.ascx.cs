...
namespace Mediachase.Cms.Website.Structure.User.NWTDControls.Controls.Catalog {
	public partial class EntryView : BaseStoreUserControl, ICmsDataAdapter {

		/// <summary>
		/// The depository being used.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the Item Code data. 
		/// </summary>
		...
		protected void Page_PreRender(object sender, EventArgs e) {
			if (CMSContext.Current.IsDesignMode)
				divProductViewer.InnerHtml = "NWTD Catalog Entry Viewer Control";
		}
