...
namespace Mediachase.Cms.Website.Structure.User.NWTDControls.Controls.User {
	/// <summary>
	/// This conftrol provides password recovery funcionality.
	/// </summary>
	public partial class RecoverPassword : BaseStoreUserControl {
		...
		void PasswordRecovery1_SendingMail(object sender, MailMessageEventArgs e) {
			...
			UserCredentials credentials = new UserCredentials() { User = PasswordRecovery1.UserName, Password = newPwd, Site = dto.Site[0].Name };
			...
			e.Message.Body = TemplateService.Process("nwtd-profile-remindpassword", Thread.CurrentThread.CurrentCulture, dic);
		}
		#endregion
