<%@ Control 
	...
	Inherits="Mediachase.Cms.Website.Templates.MSSD.Modules.BookSearchControl" %>
...
<p>Welcome to the Mountain State Schoolbook Depository Online Catalog!  From here you have access to information on over 100,000 titles from over 50 publishers.</p>

<p>You can search our catalog in two different ways - via an ISBN/Keyword search or via a Category search.</p>

<p><strong>ISBN / Keyword search:</strong> We recommend you use this method if you know the ISBN of the material you are looking for (or know the title of the book).  To perform an ISBN / Keyword search, simply enter the ISBN (or title) into the white search box above and click on the "Search" button.  You can also perform searches by entering partial ISBNs or only certain keywords out of a title.</p>
...
<p>If you are looking for a unique title or have any questions, please give us a call at 801-773-3200 or 800-995-1444.<br />We are open from 8:00am - 4:30pm Mountain time Monday - Friday.</p>
