<%@ Control 
	...
	Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.DefaultTemplate" 
	CodeBehind="DefaultTemplate.ascx.cs" %>
...
<%@ Register Src="~/Structure/Base/Controls/Common/ThemedControlModule.ascx" TagName="ThemedControlModule"
    TagPrefix="cms" %>
<%@ Register Src="~/Templates/NWTD/MainMenuControl.ascx" TagPrefix="cms" TagName="Menu" %>
<%@ Register Src="~/Templates/NWTD/FooterModule.ascx" TagPrefix="cms" TagName="Footer" %>
<%@ Register Src="~/Templates/Everything/Modules/SideMenuControl.ascx" TagPrefix="cms" TagName="SideMenu" %>
...
<%@ Register src="~/Structure/User/NWTD/Controls/Cart/ListCarts.ascx" tagname="ListCarts" tagprefix="nwtd" %>
...
<div id="bodywrapper">
    ...
    <div class="pagewrapper clearfix">
        ...
        <div id="yourCart" style="position:absolute;right:0;>
    		<nwtd:ListCarts ID="ListCarts1" runat="server" />
		</div>
