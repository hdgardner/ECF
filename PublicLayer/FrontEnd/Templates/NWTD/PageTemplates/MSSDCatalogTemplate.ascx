<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSSDCatalogTemplate.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.MSSDCatalogTemplate" %>
