...
namespace Mediachase.Cms.Website.Templates.NWTD.PageTemplates {
    ...
    public partial class MSSDHomeTemplate : BaseStoreUserControl, IPublicTemplate {
        ...
        // NOTE: The various components to my slideshow solution are in: MSSDHomeTemplate.ascx, MSSD -> home_v2.css, and here in this .ascx.cs
            ...
            string xmlPath = Server.MapPath("~/Repository/HomePage_Slideshow/SlideshowImagePaths_MSSD.xml");
