<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSSDItemDetailTemplate.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.MSSDItemDetailTemplate" %>
