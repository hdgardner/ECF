<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSSDLeftNav2ColumnTemplate.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.MSSDLeftNav2ColumnTemplate" %>
