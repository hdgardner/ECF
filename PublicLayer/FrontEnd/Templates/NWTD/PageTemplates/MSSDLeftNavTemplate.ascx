<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSSDLeftNavTemplate.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.MSSDLeftNavTemplate" %>
