<%@ Control Language="C#" Inherits="Mediachase.Cms.Templates.NWTD.UserStatusModule" Codebehind="UserStatusModule.ascx.cs" EnableViewState="false"%>
...
<asp:UpdatePanel runat="server" ID="upShoppingCart" UpdateMode="Conditional">
    ...
    <ContentTemplate>
		...
		<asp:LoginView ID="LoginView1" runat="server" EnableViewState="false">
			<AnonymousTemplate>
				<asp:HyperLink runat="server" NavigateUrl='<%#ResolveUrl("~/login.aspx")%>'><%=RM.GetString("MAIN_ACCOUNT_LOGIN")%></asp:HyperLink>
			</AnonymousTemplate>
			<LoggedInTemplate>
