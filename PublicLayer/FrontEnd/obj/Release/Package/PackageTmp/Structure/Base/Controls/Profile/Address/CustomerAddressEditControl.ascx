<%@ Control Language="c#" Inherits="Mediachase.Cms.Controls.CustomerAddressEditControl" Codebehind="CustomerAddressEditControl.ascx.cs" %>
...
<table style="width: 100%; text-align: left" border="0" cellspacing="1" cellpadding="5">
	<tr>
		<td style="width: 100%">
			<h1>
				<%=RM.GetString("ACCOUNT_ADDRESS_EDIT_TITLE")%>
			</h1>
		</td>
	</tr>
	<tr>
