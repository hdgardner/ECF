...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Entry.Entries.Entry != null && this.Entry.Entries.Entry.Length > 0)
        {
            SkuInfo.Entry = this.Entry.Entries.Entry[0];
    ...
    public Price SalePrice
    {
        get
        {
            if (_SalePrice == null)
            {
                StoreHelper.GetSalePrice(Entry
            }
        }
    }
     * */
...
<table cellpadding="3" cellspacing="0" border="0" id="Table1">
	...
	<tr valign="top">
		<td><!-- images -->
		    <!--
            <cms:MetaImage OpenFullImage="true" AlternateText='<%#Entry.ItemAttributes["DisplayName"] %>' ShowThumbImage="false" ID="PrimaryImage" PropertyName="PrimaryImage" DataSource="<%#Entry.ItemAttributes.Image%>" runat="server" />
            -->
            <uc2:FlashImageModule ID="FlashImageModule1" runat="server" Code='<%#Code %>' />
