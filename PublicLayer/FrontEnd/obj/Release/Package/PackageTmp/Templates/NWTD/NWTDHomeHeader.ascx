<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NWTDHomeHeader.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.NWTDHomeHeader" %>
...
<div class="nwtd-header">
   <a href="/" style="float: left;"><img id="Img1" src="~/App_Themes/NWTD/images-template/nwtd-logo.png" runat="server" alt="Northwest Textbook Depository" /></a>
</div>
    <div class="need-help">
