<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NWTDHomeTemplate.ascx.cs" Inherits="Mediachase.Cms.Website.Templates.NWTD.PageTemplates.NWTDHomeTemplate" %>
<%@ Register Src="~/Structure/User/NWTDControls/Controls/Catalog/SearchByPublisher.ascx" TagName="SearchBar" TagPrefix="NWTD" %>
<%@ Register Src="~/Templates/NWTD/NWTDHomeHeader.ascx" TagName="HomeHeader" TagPrefix="NWTD" %>
...
<div id="center">
	...
	<div id="nwtd-page" class="nwtd-homePage">
		...
		<div id="nwtd-pageContent" class="nwtd-homePageContent">
			...
			<asp:Image runat="server" ImageUrl="~/App_Themes/NWTD/images-template/home-page-banner-placeholder.png" Width="975" Height="253" Visible="false" />
        ...
        <%--    <OakTree:SWFObject 
				    ...
				    <FlashVars>
					    <OakTree:SWFFlashVar Name="sitevar" Value="nwtd" />
				    </FlashVars>
				    <AlternateContent>
...
<%-- NON-FLASH SLIDESHOW END (HDG 10/10/17) **************************************************************************************** --%>   
            ...
            <!-- <h3 class="home">We are here for you!  Call us Monday through Friday 8:00am – 4:30pm (Pacific time) at 800.676.7736 or 503.906.1100 </h3> -->
