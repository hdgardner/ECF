...
namespace UnitTests.Common
{
    ...
    /// </summary>
    public abstract class AdminWebTestBase : WebTestBase
    {
        ...
        /// </summary>
        public AdminWebTestBase() : base()
        {
            _CommerceManagerUrl = "http://ecf50.dev.mediachase.com/ConsoleManager";//GetConfigSetting("commercemanager-url");
        }
